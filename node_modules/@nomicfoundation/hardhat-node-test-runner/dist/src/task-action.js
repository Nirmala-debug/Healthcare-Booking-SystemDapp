...
const testWithHardhat = async ({ testFiles, only, grep, noCompile, testSummaryIndex }, hre) => {
    ...
    if (hre.globalOptions.coverage === true ||
        ...
        const testWorkerDone = new URL(import.meta.resolve("@nomicfoundation/hardhat-node-test-runner/test-worker-done"));
    ...
    await hre.hooks.runHandlerChain("test", "onTestRunStart", ["nodejs"], async () => { });
    const testResults = await runTests();
    await hre.hooks.runHandlerChain("test", "onTestRunDone", ["nodejs"], async () => { });
    console.log();
    const result = { summary: testResults };
